...
class AttentionWithoutNormalization(Layer):
    """
    Attention operation, with a context/query vector, for temporal data.
    Supports Masking.
    Follows the work of Yang et al. [https://www.cs.cmu.edu/~diyiy/docs/naacl16.pdf]
    ...
    def __init__(self,
        ...
        self.bias = bias
        super(AttentionWithoutNormalization, self).__init__(**kwargs)
    ...
    def build(self, input_shape):
        ...
        super(AttentionWithoutNormalization, self).build(input_shape)
